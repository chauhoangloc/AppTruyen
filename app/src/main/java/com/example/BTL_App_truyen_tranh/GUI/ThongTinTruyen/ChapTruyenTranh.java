...
import static com.example.BTL_App_truyen_tranh.GUI.Home.HomePage.sqLite1;
...
public class ChapTruyenTranh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getStringExtra("Key_tenChap") != null) {
            list = getall_imgchap(intent.getStringExtra("Key_tenChap"), intent.getIntExtra("Key_idTruyen", 0), sqLite1);
            tenchap.setText(intent.getStringExtra("Key_tenChap"));
            ListImgChap();

        }
        List<Chap> listchap = getall_chap(intent.getIntExtra("Key_idTruyen", 0), sqLite1);
        ...
        button_truoc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(position>0){
                    ...
                    list = getall_imgchap(listchap.get(position).getTenChap(), intent.getIntExtra("Key_idTruyen", 0), sqLite1);
